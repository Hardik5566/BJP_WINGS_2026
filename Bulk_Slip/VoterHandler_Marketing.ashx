<%@ WebHandler Language="C#" Class="VoterHandler_Marketing" %>
...
public class VoterHandler_Marketing : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            string apiResult = SendWhatsApp(mobile, publicUrl, "1", booth, sr, name, "Voter Slip");
