<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sleep_Send_Marketing.aspx.cs" Inherits="Sleep_Send_Marketing" %>
                ...
                <div class="slip-wrapper">
                    <div id="voter-card" class="voter-slip-card">
                        ...
                        <div class="booth-container">
                            <div class="booth-item"><span class="booth-label">भाग</span><span id="slipAc"></span></div>
       ...
       async function startProcess() {
           ...
           for (let i = 0; i < 3; i++) {
               ...
               try {
                   ...
                   await $.ajax({
                       type: "POST",
                       url: "VoterHandler_Marketing.ashx",
                       data: JSON.stringify({
