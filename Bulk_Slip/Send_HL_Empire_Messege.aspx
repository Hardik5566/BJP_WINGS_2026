<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Send_HL_Empire_Messege.aspx.cs" Inherits="Send_HL_Empire_Messege" %>
...
<head runat="server">
    ...
    <style>
        ...
        #name {
    white-space: pre-wrap; /* This tells the browser to keep all spaces */
            ...
            <div id="live-preview-container" style="display: none;">
                <div class="slip-wrapper">
                    <div id="voter-card" class="voter-slip-card">
                        <img src="img/a.jpeg" class="slip-header-img" />
                        <div class="slip-content">
                            <div class="info-row"><strong>Hello </strong>&nbsp;<span id="name"></span></div>
                        </div>
                    </div>
                </div>
            </div>
   ...
   <script>
       ...
       async function startProcess() {
           ...
           for (let i = 0; i < voters.length; i++) {
               ...
               // This replaces the normal space with a non-breaking space that won't collapse
               document.getElementById('name').innerText = " " + v.name.replace(" ", "\u00A0");
               ...
               try {
                   ...
                   await $.ajax({
                       type: "POST",
                       url: "HLEmpireHandler.ashx",
                       data: JSON.stringify({
                           name: v.name, inq_no: v.inq_no, img: base64,
                           product: v.product, protype: v.protype, size: v.size, mobile: v.Mobile
                       }),
