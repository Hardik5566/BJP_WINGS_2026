<%@ WebHandler Language="C#" Class="HLEmpireHandler" %>
...
public class HLEmpireHandler : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            string inq_no = data["inq_no"].ToString();
            string product = data["product"].ToString();
            string protype = data["protype"].ToString();
            ...
            string fileName = $"Card_{inq_no}_{DateTime.Now:yyyyMMddHHmmssfff}.jpg";
            ...
            string publicUrl = "https://maharashtra.bjpwings.com/VoterCards/" + fileName;

            string apiResult = SendWhatsApp(mobile, publicUrl, name, inq_no, product, protype, size);
    ...
    public string SendWhatsApp(string mobile, string imgUrl, string v1, string v2, string v3, string v4, string v5)
    {
        using (HttpClient client = new HttpClient())
        {
            ...
            {
                throw new Exception("Meta API Error : " + result);
            }
